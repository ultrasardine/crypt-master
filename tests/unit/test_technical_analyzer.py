...
class TestBollingerBands:
    ...
    def test_bollinger_with_insufficient_data(self, analyzer: TechnicalAnalyzer) -> None:
    ...
    def test_bollinger_custom_params(
        ...
        result = analyzer.calculate_bollinger_bands(sample_prices, period=10, std_dev=1.5)
...
class TestADX:
    ...
    def test_adx_with_sufficient_data(
        ...
        result = analyzer.calculate_adx(ohlcv_data["high"], ohlcv_data["low"], ohlcv_data["close"])
    ...
    def test_adx_custom_period(
        ...
        result = analyzer.calculate_adx(
            ohlcv_data["high"], ohlcv_data["low"], ohlcv_data["close"], period=7
        )
...
class TestStochastic:
    ...
    def test_stochastic_with_insufficient_data(self, analyzer: TechnicalAnalyzer) -> None:
