...
class TestWeightedCalculation:
    ...
    def test_multiple_technical_indicators_averaged(self, scorer: ConfidenceScorer) -> None:
...
class TestConflictHandling:
    ...
    def test_no_conflict_with_hold_indicators(self, scorer: ConfidenceScorer) -> None:
...
class TestSignalGeneration:
    ...
    def test_hold_signal_with_all_hold_indicators(self, scorer: ConfidenceScorer) -> None:
...
class TestInsufficientData:
    ...
    def test_insufficient_data_excluded(self, scorer: ConfidenceScorer) -> None:
        ...
        technical = [
            create_indicator("RSI", SignalDirection.BUY, 80.0, weight=0.5),
            create_indicator(
                "MACD", SignalDirection.SELL, 80.0, weight=0.5, data_insufficient=True
            ),
        ]
    ...
    def test_all_insufficient_data_returns_hold(self, scorer: ConfidenceScorer) -> None:
        ...
        sentiment = create_indicator(
            "FGI", SignalDirection.BUY, 80.0, weight=1.0, data_insufficient=True
        )
...
class TestBreakdownMetadata:
    ...
    def test_breakdown_includes_all_indicators(self, scorer: ConfidenceScorer) -> None:
...
class TestConfidenceResult:
    ...
    def test_confidence_result_is_immutable(self, scorer: ConfidenceScorer) -> None:
    ...
    def test_confidence_result_default_values(self, scorer: ConfidenceScorer) -> None:
