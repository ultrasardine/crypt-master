...
class TestTradeValidation:
    ...
    def test_trade_validation_warning_approaching_limit(
...
class TestBotValidation:
    ...
    def test_bot_rejected_with_existing_allocation(
        self, risk_manager: RiskManager
    ) -> None:
    ...
    def test_bot_validation_warning_approaching_limit(
        self, risk_manager: RiskManager
    ) -> None:
...
class TestAvailableBotAllocation:
    ...
    def test_available_allocation_with_existing_bots(
        self, risk_manager: RiskManager
    ) -> None:
