...
class TestMinimumConfidenceThreshold:
    ...
    def test_signal_above_threshold_keeps_direction(self, generator: SignalGenerator) -> None:
        ...
        signal = generator.generate_signal("BTC_USDT", technical, sentiment, news)
    ...
    def test_signal_below_threshold_becomes_hold(self, generator: SignalGenerator) -> None:
    ...
    def test_sell_signal_below_threshold_becomes_hold(self, generator: SignalGenerator) -> None:
...
class TestSignalGeneration:
    ...
    def test_signal_contains_direction(self, generator: SignalGenerator) -> None:
        ...
        signal = generator.generate_signal("ETH_USDT", technical, sentiment, news)
    ...
    def test_signal_contains_confidence_score(self, generator: SignalGenerator) -> None:
...
class TestSignalMetadata:
    ...
    def test_signal_contains_all_indicators(self, generator: SignalGenerator) -> None:
    ...
    def test_signal_contains_threshold_info(self, generator: SignalGenerator) -> None:
    ...
    def test_get_signal_metadata_returns_dict(self, generator: SignalGenerator) -> None:
    ...
    def test_metadata_contains_indicator_details(self, generator: SignalGenerator) -> None:
        """Metadata should contain detailed indicator information."""
        technical = [
            create_indicator("RSI", SignalDirection.BUY, 80.0, weight=0.5, value=35.0),
        ]
...
class TestWouldExecute:
    ...
    def test_would_execute_buy_above_threshold(self, generator: SignalGenerator) -> None:
    ...
    def test_would_execute_sell_above_threshold(self, generator: SignalGenerator) -> None:
    ...
    def test_would_not_execute_below_threshold(self, generator: SignalGenerator) -> None:
    ...
    def test_would_not_execute_hold_signal(self, generator: SignalGenerator) -> None:
...
class TestSignalImmutability:
    ...
    def test_signal_indicators_are_tuple(self, generator: SignalGenerator) -> None:
...
class TestEdgeCases:
    ...
    def test_empty_technical_indicators(self, generator: SignalGenerator) -> None:
    ...
    def test_all_insufficient_data(self, generator: SignalGenerator) -> None:
        ...
        technical = [
            create_indicator("RSI", SignalDirection.BUY, 80.0, weight=1.0, data_insufficient=True),
        ]
    ...
    def test_reasoning_includes_threshold_info_when_below(self, generator: SignalGenerator) -> None:
...
class TestMinConfidenceThresholdProperty:
    ...
    def test_min_confidence_threshold_property(self, generator: SignalGenerator) -> None:
