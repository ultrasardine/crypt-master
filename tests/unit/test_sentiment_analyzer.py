...
class TestSignalGeneration:
    ...
    def test_extreme_fear_generates_buy_signal(self, analyzer: SentimentAnalyzer) -> None:
    ...
    def test_extreme_greed_generates_sell_signal(self, analyzer: SentimentAnalyzer) -> None:
        """Values 75-100 (Extreme Greed) should generate SELL signal."""
        for value in [75, 85, 95, 100]:
            signal = analyzer.value_to_signal(value)
            assert signal == SignalDirection.SELL

    def test_neutral_zone_generates_hold_signal(self, analyzer: SentimentAnalyzer) -> None:
...
class TestErrorHandling:
    ...
    @pytest.mark.asyncio
    async def test_network_error_returns_hold_signal(self, config: SentimentConfig) -> None:
    ...
    @pytest.mark.asyncio
    async def test_timeout_error_returns_hold_signal(self, config: SentimentConfig) -> None:
    ...
    @pytest.mark.asyncio
    async def test_invalid_response_returns_hold_signal(self, config: SentimentConfig) -> None:
    ...
    @pytest.mark.asyncio
    async def test_http_error_returns_hold_signal(self, config: SentimentConfig) -> None:
...
class TestCaching:
    ...
    @pytest.mark.asyncio
    async def test_force_refresh_bypasses_cache(self, config: SentimentConfig) -> None:
...
class TestContextManager:
    ...
    @pytest.mark.asyncio
    async def test_context_manager_closes_client(self, config: SentimentConfig) -> None:
    ...
    @pytest.mark.asyncio
    async def test_injected_client_not_closed(self, config: SentimentConfig) -> None:
        """Injected HTTP client should not be closed by analyzer."""
        mock_client = AsyncMock(spec=httpx.AsyncClient)

        async with SentimentAnalyzer(config=config, http_client=mock_client) as analyzer:
            pass
