...
class TestSignalSerialization:
    ...
    def test_signal_to_json_contains_required_fields(
        self, agent, sample_signal
    ):
...
class TestAsyncMethods:
    ...
    @pytest.mark.asyncio
    async def test_get_sentiment_score_returns_indicator_score(
        self, agent, mock_settings
    ):
        """_get_sentiment_score should return IndicatorScore."""
        from lib.analysis.sentiment import SentimentResult, FearGreedClassification
        ...
        agent._sentiment_analyzer.get_fear_greed_index = AsyncMock(
    ...
    @pytest.mark.asyncio
    async def test_get_sentiment_score_handles_unavailable(
        self, agent, mock_settings
    ):
...
class TestNewsAnalysisIntegration:
    ...
    @pytest.mark.asyncio
    async def test_get_news_score_returns_none_when_disabled(
        self, agent_without_news
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_news_score_returns_indicator_score(
        self, agent_with_news
    ):
        ...
        agent_with_news._news_analyzer.analyze_news = AsyncMock(
            return_value=mock_result
        )
    ...
    @pytest.mark.asyncio
    async def test_get_news_score_handles_ollama_unavailable(
        self, agent_with_news
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_news_score_handles_data_unavailable(
        self, agent_with_news
    ):
