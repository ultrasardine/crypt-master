    ...
    **Validates: Requirements 9.4**
    ...
    def test_risk_config_defaults_applied(
        ...
        **Validates: Requirements 9.4**
        ...
        for key in ["max_position_pct", "max_risk_per_trade", "max_drawdown", 
                    "min_confidence", "bot_loss_threshold"]:
    ...
    def test_analysis_config_defaults_applied(
        ...
        **Validates: Requirements 9.4**
        ...
        # Check that missing values have defaults
        for key in ["interval_seconds", "rsi_period", "macd_fast", "macd_slow",
